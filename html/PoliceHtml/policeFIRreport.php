...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO fir (reportDate,reportTime,incidentDate, incidentTime, officerId,incidentLocation,incidentDetails,aressted,suspecfirstName,suspectlastName,comments,AGE,CrimeType) VALUES('$reportDate','$reportTime','$incidentDate','$incidentTime','$id','$incidentLocation','$incidentDetail','$anyoneArrest','$suspectFirstName','$suspectLastName','$comments','$age','$crimeType')";
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <section>
                            <div class="container my-4 row g-3">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                    <div class="row my-3 fontColor" >
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="date" class="form-control" aria-label="First name" name="reportDate" min="2023-04-19" max="2023-04-19" style="background:#1b203d; color:white" id="validationDefault01" required>
                                        </div>
                                        <div class="col">
                                            <label for="time" class="form-label">Report Time:</label>
                                            <input type="time" class="form-control" aria-label="Last name" name="reportTime" style="background:#1b203d; color:white" required>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row my-3 fontColor">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="date" class="form-control" aria-label="First name" name="incidentDate" min="2023-03-25" max="2023-04-19" style="background:#1b203d; color:white" required>
                                        </div>
                                        <div class="col">
                                            <label for="time" class="form-label">Incident Time:</label>
                                            <input type="time" class="form-control" aria-label="Last name" name="incidentTime" style="background:#1b203d; color:white" required>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <hr class="my-3"> -->
                                        ...
                                        <div class="row g-3 my-3 fontColor">
                                            ...
                                            <textarea class="form-control" rows="4" name="incidentLocation" style="background:#1b203d; color:white" required></textarea>
                                        </div>

                                        <div class="row g-3 my-3 fontColor">
                                            <label class="form-label">Incident details:</label>
                                            <textarea class="form-control" name="incidentDetail" rows="4" style="background:#1b203d; color:white" required></textarea>
                                        </div>
                                        ...
                                        <div class="row g-3 my-3 fontColor">
                                            ...
                                            <textarea class="form-control" name="anyoneArrest" rows="4" style="background:#1b203d; color:white" required></textarea>
                                        </div>
                                        ...
                                        <div class="row my-3 fontColor">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" placeholder="First name" aria-label="First name" name="suspectFirstName" style="background:#1b203d; color:white" required>
                                            </div>
                                            <div class="col">
                                                <input type="text" class="form-control" placeholder="Last name" aria-label="Last name" name="suspectLastName" style="background:#1b203d; color:white" required>
                                            </div>
                                        </div>

                                        <div class="row g-3 my-3 fontColor">
                                            <label class="form-label">Enter the Age of suspect.</label>
                                            <input type="number" class="form-control" placeholder="Enter the Age"name="age" min="8" max="90" style="background:#1b203d; color:white" required></input>
                                        </div>
                                        ...
                                        <div class="row g-3 my-3 fontColor">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="crimeType" style="max-width: 40rem; display:inline;background:#1b203d; color:white">
                                                <option value="None" style="background:#1b203d; color:white" required>--Select crime type--</option>
                    ...
                    <input type="file" id="img" accept=".jpg, .jpeg, .png" name="images">
                                        ...
                                        <div class="row g-3 my-4 fontColor">
                                            ...
                                            <textarea class="form-control" name="comments" rows="4" style="background:#1b203d; color:white" required></textarea>
                                        </div>

                                        <div class="container line my-3 fontColor"></div>
                                        <hr>
                                        <div class="form-check my-4 fontColor">
                                            <input class="form-check-input " type="checkbox" value="" id="flexCheckIndeterminate" style="background:#1b203d; color:white" required>
