  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="sign-in-form row g-3" method="post">
          <h2 class="title">Sign in</h2>
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="email" placeholder="john@gmail.com" name="email" id="validationDefault01"  required/>
          </div>

          <div class="input-field">
            <i class="fas fa-lock"></i>
            <input type="password" placeholder="Password" name="Password" id="validationDefault02" required/>
          </div>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="sign-up-form row g-3" method="post">
          <h2 class="title">Sign up</h2>
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" placeholder="Username" name="userName" id="validationDefault01" required/>
          </div>
          <div class="input-field">
          ...
          <div class="input-field">
            ...
            <input type="contact" placeholder="contact" name="contact" required maxlength="10" minlength="10"/>
          </div>
          <div class="input-field">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3>New here ?</h3>
          <p>
            Signup and continue to explore
          </p>
      ...
      <div class="panel right-panel">
        <div class="content">
          <h3>One of us ?</h3>
          <p>
            Already a member signIn and continue.
          </p>
