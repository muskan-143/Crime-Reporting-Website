    ...
    <div id="main" style="color:white">
        <div style="height:2rem;">
            ...
            if ($insert == 1) {
                ...
                ';
            } else if ($insert == "NoValue") {
                echo '
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Officer ID: ' . $inChareId . '</strong> not existing.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                        ...
                        <div class="modal-body">
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="inChargeId" placeholder="Enter the id of the police InCharge" name="InChargeId" pattern="[1-9]{1}[0-9]{0,3}" required onkeypress="return onlyNumberKey(event)" title="Id can't be more then 4 digit"></input>
                                </div>
