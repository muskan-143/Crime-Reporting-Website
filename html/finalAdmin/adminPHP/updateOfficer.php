...
<body>
                            ...
                            <form class="row g-3" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                ...
                                <div class="row g-3 ">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" name="officerName" id="firstName" pattern="\w{4,16}" title="Minimum 4 character" required>

                                    </div>
                                    <div class="col">
                                        <label for="" class="form-label">Middle Name</label>

                                        <input type="text" class="form-control" aria-label="middle name" name="middleName" pattern="\w{4,16}" title="Minimum 4 character" required>
                                    </div>
                                    <div class="col">
                                        <label for="" class="form-label">Last Name</label>

                                        <input type="text" class="form-control" aria-label="Last name" name="lastName" pattern="\w{4,16}" title="Minimum 4 character" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="email" placeholder="Enter the Email" type="email" required name="officerEmail" title="Please enter valid email"></input>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="contact" placeholder="Enter the contact" type="phone" required name="officerContact" pattern="[1-9]{1}[0-9]{9}" title="Minimum 10 character and 0 should be the first digit" onkeypress="return onlyNumberKey(event)"></input>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="age" placeholder="Enter the Age" type="number" required name="officerAge" pattern="[1-9]{1}[0-9]{1}"  title="Enter age between 20-60"></input>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="pinCode" placeholder="Enter the Pin Code" type="number" name="officerPinCode" pattern="[1-9]{1}[0-9]{2}\\s{0, 1}[0-9]{3}$" title = "Enter a valid pinCode" required></input>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    <label for="password" class="form-label">Password (8 character minimum)</label>
                                    <input class="form-control" id="password" placeholder="Enter the password" type="password" required name="officerPassword" minlength="8"></input>
                                    <div class="invalid-feedback">
    ...
    <script src="../../../js/admin/addOfficer.js"></script>
